...
//         <h1>Overview</h1>
//         <p className="lead">
//           Sing App React is an admin dashboard template built with React 16.5.2.
//           Sing App goes beyond usual admin templates and provides you entire
//           intuitive programming framework. Server Side Rendering and Node.js
//           backend will even further speed up your development. You can use Sing
//           App React to build any type of web applications like SAAS, CMS,
...
//           for details
//         </p>
//         <img className="img-responsive w-100 border" alt="screenshot" />
