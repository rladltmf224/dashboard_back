...
class Grid extends React.Component {
  ...
  updateWidgetData = (widget) => {
    ...
    console.log('widget',widget, this);
    // console.log("this.state state :: ", state);
    console.log("this.state this.state.gridData :: ", this.state.gridData);
    console.log("this.state mock.updatedData :: ", mock.updatedData);
    console.log("this.state mock.mainData :: ", mock.mainData);
