import { RECEIVED_DATA_SUCCESS, RECEIVING_DATA } from '../actions/personalservice'; //이렇게 두개의 액션타입을 사용함
...
export default function personalserviceReducer(state = defaultState, action) {
